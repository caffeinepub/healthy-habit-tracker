  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'teal-dark': 'oklch(0.33 0.065 196)',
        'teal-mid': 'oklch(0.40 0.06 192)',
        'teal-accent': 'oklch(0.63 0.13 172)',
        'mint-pale': 'oklch(0.88 0.05 168)',
        'mint-light': 'oklch(0.96 0.025 168)',
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        card: "0 1px 3px 0 oklch(0.18 0.03 196 / 0.08), 0 1px 2px -1px oklch(0.18 0.03 196 / 0.06)",
        'card-hover': "0 4px 12px 0 oklch(0.18 0.03 196 / 0.12)",
